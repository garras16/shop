<?php
$sql=mysql_query("SELECT * FROM retur_beli_detail WHERE id_retur_beli=$id AND qty_keluar IS NOT NULL");
...
WHERE id_beli=$id_beli");
								while($b=mysql_fetch_array($cust)){
									...
									$sql=mysql_query("SELECT SUM(qty_retur) AS jumlah FROM retur_beli_detail WHERE id_barang_masuk_rak=" .$b['id_barang_masuk_rak']);
