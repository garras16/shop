                    ...
                    <div class="x_content">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar fa-fw" style="width: 51px;"></i><br>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-file fa-fw" style="width: 51px;"></i><br>
                                        <small>No. Nota</small>
                                    </span>
                                    <input
                                        id="no_nota"
							...
							?>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-balance-scale fa-fw" style="width: 51px;"></i><br>
                                        <small>Berat</small>
                                    </span>
                                    <input
                                        class="form-control"
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-money fa-fw" style="width: 51px;"></i><br>
                                        <small>Tarif</small>
                                    </span>
                                    <input
                                        class="form-control"
                    ...
                    <div class="x_content">
                        <p align="right">
                            <a
                                data-toggle="modal"
                                data-target="#myModal"
                                data-id-beli="<?php echo $id ?>"
                                data-id-supplier="<?php echo $id_supplier ?>"
                                ...
                                <div class="col-md-5 text-right">
                                    <div class="input-group">
                                        <span
                                            ...
                                            style="width:200px;text-align:left;color:#000;background: #fff; outline: none; border: none;">Berat Datang (gr)</span>
                                        <input
                                    ...
                                    <div class="input-group">
                                        <span
                                            class="input-group-addon"
                                            style="width:200px;text-align:left;color:#000;background: #fff; outline: none; border: none;">Volume Datang (cm3)</span>
                                        <input
                                            stle="width:256px"
                                            class="form-control text-right"
                                            style="background: #fff; outline: none; border: none;"
...
WHERE
	...
	AND barang.status=1");
							...
							?>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-money fa-fw" style="width: 38px;"></i><br>
                                        <small>Harga</small>
                                    </span>
                                    <input
                                        class="form-control"
