...
if ($row['status']=='1'){
	...
	echo '			<tr>
						...
						<td align="right" style="width: 190px;">' .format_uang($row['jumlah']). '</td>
						<td align="right" style="width: 190px;">' .format_uang($sisa_nota). '</td>
...
function submit(){
	window.location="?page=pembelian&mode=bayar_nota&dari=" + $('#tgl_dari').val() + "&sampai=" + $('#tgl_sampai').val();
}
