                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <select id="select_kec" class="select2 form-control" name="id_kec"></select>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <select id="select_kel" class="select2 form-control" name="id_kel"></select>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group">
...
<script>
    $('#myModal2').on('show.bs.modal', function (e) {
        ...
        $('#select_supplier').load(
            'api/web/get-supplier-modal.php?id_supplier=' + id_supplier + '&id_negara=' +
                    id_negara + '&id_prov=' + id_prov + '&id_kab=' + id_kab + '&id_kec=' +
                    id_kec + '&id_kel=' + id_kel,
            function (e) {
