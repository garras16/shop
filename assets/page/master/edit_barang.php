...
<div class="right_col" role="main">
	<div class="">
		<div class="row">
			...
			?>
			<a href="?page=barang" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a>
			<form action="" method="post">
				...
				<div class="form-group col-sm-12">
					...
					<div class="input-group">
						...
						<input id="min_order" name="min_order" class="form-control" placeholder="Minimal Jual" min="1" onKeyPress="if(this.value.length==3) return false;" value="<?php echo $row['min_order']; ?>" type="number" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-warning fa-fw"></i></span>
						<input id="min_order" name="stok_minimal" class="form-control" placeholder="Stok Minimal" min="1" onKeyPress="if(this.value.length==3) return false;" value="<?php echo $row['min_order']; ?>" type="number" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group">
