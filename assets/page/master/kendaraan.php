            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <p align="right">
                            <a class="btn btn-warning" href="?page=kendaraan&mode=riwayat">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                ...
                                id="perbandingan"
                                name="perbandingan"
                                placeholder="Perbandingan KM / 1 L"
                                required="required">
                            <span class="input-group-addon">
                                <i class="fa fa-star fa-fw" style="color:red"></i>
                            </span>
                        ...
                        <div class="input-group">
                            <span class="input-group-addon" style="padding: 2px 12px;">
                                <i class="fa fa-flag fa-fw" style="width: 48px;"></i><br>
                                <small>Status</small>
                            </span>
                            <select
                                class="form-control select"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div id="get_kendaraan" class="col-md-12"></div>
                    <div class="modal-footer">
    ...
    $(document).ready(function () {
        $('#myModal2').on('show.bs.modal', function (e) {
            ...
            $('#get_kendaraan').load('api/web/get-kendaraan.php?id=' + id, function () {
                ...
                $('#perbandingan_2').inputmask('decimal', {
                    allowMinus: false,
                    autoGroup: true,
                    groupSeparator: '.',
                    rightAlign: false,
        ...
        $('#perbandingan').inputmask('decimal', {
            allowMinus: false,
            autoGroup: true,
            groupSeparator: '.',
            rightAlign: false,
