	...
	<div class="">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<p align="right"><button class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Tambah Gudang</button>
				<button class="btn btn-primary" data-toggle="modal" data-target="#myModal2"><i class="fa fa-plus"></i> Tambah Rak</button></p>
		...
		<div class="modal-content">
			...
			<div class="modal-body">				
				<form action="" method="post">
					...
					<div id="get_rak" class="col-md-12">
