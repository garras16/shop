            ...
            <form action="" method="post">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="input-group">
                        ...
                        <select id="select_kab" class="form-control" name="id_kab" required="required">
                    ...
                    <div class="input-group">
                        ...
                        <select id="select_kec" class="form-control" name="id_kec" required="required">
                    ...
                    <div class="input-group">
                        ...
                        <select id="select_kel" class="form-control" name="id_kel" required="required">
