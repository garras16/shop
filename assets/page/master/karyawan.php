			...
			<div class="modal-body">				
				<form action="" method="post">
					...
					<div class="input-group" style="margin-bottom:5px;">
						<span class="input-group-addon"><i class="fa fa-user fa-fw" style="width:58px;"></i><br><small>Nama</small></span>
						<input class="form-control" style="padding:20px 15px;" id="nama" type="text" name="nama_karyawan" placeholder="Nama Karyawan" title="Nama Karyawan" maxlength="50" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group" style="margin-bottom:5px;">
						<span class="input-group-addon"><i class="fa fa-barcode fa-fw" style="width:58px;"></i><br><small>Barcode</small></span>
						<input name="barcode" style="padding:20px 15px;" class="form-control" type="text" placeholder="Barcode" title="Barcode" maxlength="10" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group" style="margin-bottom:5px;">
						<span class="input-group-addon"><i class="fa fa-credit-card fa-fw" style="width:58px;"></i><br><small>No. KTP</small></span>
						<input class="form-control" style="padding:20px 15px;" type="number" name="ktp" placeholder="No. KTP" title="No. KTP" onKeyPress="if(this.value.length==16) return false;" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group" style="margin-bottom:5px;">
						<span class="input-group-addon"><i class="fa fa-phone fa-fw" style="width:58px;"></i><br><small>No. HP</small></span>
						<input class="form-control" style="padding:20px 15px;" type="number" name="no_hp" placeholder="No. HP" title="No. HP" onKeyPress="if(this.value.length==15) return false;" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group" style="margin-bottom:5px;">
					...
					<div class="input-group" style="margin-bottom:5px;">
						<span class="input-group-addon"><i class="fa fa-money fa-fw" style="width:57px;"></i><br><small>Gaji Rp.</small></span>
						<input class="form-control" style="padding:20px 15px;" type="text" id="gaji" name="gaji" title="Gaji" placeholder="Gaji (Rp)" required>
						<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
					</div>
					<div class="input-group" style="margin-bottom:5px;">
						<span class="input-group-addon"><i class="fa fa-money fa-fw"></i><br><small>Harian Rp.</small></span>
						<input class="form-control" style="padding:20px 15px;" type="text" id="harian" name="harian" title="Harian" placeholder="Harian (Rp)" required>
					</div>
					<div class="input-group" style="margin-bottom:5px;">
