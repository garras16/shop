...
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon">
        <i class="fa fa-user fa-fw" style="width: 63px;"></i><br>
        <small>Nama</small>
    </span>
    <input
        class="form-control"
...
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon">
        <i class="fa fa-barcode fa-fw" style="width: 63px;"></i><br>
        <small>Barcode</small>
    </span>
    <input
        name="barcode"
...
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon">
        <i class="fa fa-credit-card fa-fw" style="width: 63px;"></i><br>
        <small>No. KTP</small>
    </span>
    <input
        class="form-control"
...
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon">
        <i class="fa fa-phone fa-fw" style="width: 63px;"></i><br>
        <small>No. HP</small>
    </span>
    <input
        class="form-control"
...
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon" style="padding: 3px 12px;">
        <i class="fa fa-briefcase fa-fw" style="width: 63px;"></i><br>
        <small>Jabatan</small>
    </span>
    <select
        class="form-control"
        ...
        <?php 
			...
			?>
        <option
            value="<?php echo $b['id_jabatan']; ?>"
            <?php echo select_opsi($row['id_jabatan'], $b['id_jabatan']) ?>><?php echo $b['nama_jabatan'];?></option>
        <?php 
				}
			?>
    </select>
...
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon">
        <i class="fa fa-money fa-fw" style="width: 63px;"></i><br>
        <small>Gaji Rp.</small>
    </span>
    <input
        class="form-control"
...
<div class="input-group" style="margin-bottom: 5px;">
    ...
    <input
        ...
        id="lembur_2"
        name="lembur"
        placeholder="Lembur(Rp)"
        title="Lembur"
        value="<?php echo $row['lembur']; ?>"
        style="padding: 20px 10px;">
</div>
<div class="input-group" style="margin-bottom: 5px;">
    <span class="input-group-addon" style="padding: 2px 12px;">
        <i class="fa fa-flag fa-fw" style="width: 62px;"></i><br>
        <small>Status</small>
    </span>
    <select
        class="form-control"
