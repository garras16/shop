...
<div id="myModal" class="modal fade">
                        ...
                        <div class="form-group col-sm-12">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa fa-flag fa-fw" style="width: 37px;"></i><br>
                                    <small>Negara</small>
                                </span>
                                <input
                                    id="add_negara"
                            ...
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa fa-tag fa-fw" style="width: 37px;"></i><br>
                                    <small>Nama</small>
                                </span>
                                <input
                                    id="tags_me"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div id="get_kecamatan" class="col-md-12"></div>
                        <div class="modal-footer">
                            <input type="submit" class="btn btn-primary" value="Simpan">
                        </div>
                    </form>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#tags_me').tagsInput(
                {maxChars: 40, minWidth: '400px', defaultText: 'Kecamatan', width: 'auto'}
            );
        });
    </script>