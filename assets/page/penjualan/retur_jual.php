            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <p align="right">
                            <a class="btn btn-primary" href="?page=penjualan&mode=cari_nota_retur">
...
if ($row['status']=='1'){
	...
	echo '			<tr>
						<td><a href="?page=penjualan&mode=retur_jual_detail&id=' .$row['id_retur_jual']. '"><div style="min-width:70px">' .date("d-m-Y", strtotime($row['tgl_retur'])). '</div></a></td>
						<td><a href="?page=penjualan&mode=retur_jual_detail&id=' .$row['id_retur_jual']. '"><div style="min-width:70px">' .$row['no_retur_jual']. '</div></a></td>
...
<script>
    ...
    function submit() {
        window.location = "?page=penjualan&mode=retur_jual&dari=" + $('#tgl_dari').val() +
