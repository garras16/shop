		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="input-group">
					...
					<input class="form-control" id="pelanggan" style="padding: 20px 15px;" name="pelanggan" placeholder="Nama Pelanggan" title="Nama Pelanggan" value="<?php echo $row['nama_pelanggan'] ?>" disabled="disabled" required>
				</div>
			</div>
			<div class="col-md-6">
				<div class="input-group">
			...
			<div class="col-md-6">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-file-excel fa-fw"></i><br><small style="font-size: 10px;">No. Nota Retur</small></span>
					<input class="form-control" id="no_nota_retur" name="no_nota_retur" style="padding: 20px 15px;" placeholder="No Nota Retur Jual" title="No Nota Retur Jual" value="<?php echo $row['no_retur_jual'] ?>" disabled="disabled" required>
				</div>
			</div>
			<div class="col-md-6">
				<div class="input-group">
			...
			<div class="col-md-6">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-tags fa-fw" style="width: 68px;"></i><br><small>Stat. Bayar</small></span>
			...
			<div class="clearfix"></div>
			<div class="col-xs-6">
				<p align="left"><a class="btn btn-danger" href="?page=penjualan&mode=retur_jual"><i class="fa fa-arrow-left"></i> Kembali</a></p>
			</div>
			<div class="col-xs-6">
			<?php
...
WHERE id_jual=$id_jual");
					...
					<div class="input-group">
						...
						<input id="qty_retur" name="qty_retur" type="tel" style="padding: 20px 15px;" class="form-control" placeholder="Qty Retur" min="0" required>
