				...
				<div class="x_panel">
					<div class="x_title">
						...
						<div class="input-group">
							<input class="form-control" style="width:100px" id="tgl_dari" type="text" value="" placeholder="Tanggal" readonly>
							<input class="form-control" style="width:100px"id="tgl_sampai" type="text" value="" placeholder="Tanggal" readonly>
							<a class="btn btn-primary" id="btn_dari_sampai" onClick="submit();"><i class="fa fa-search"></i></a>
						</div>
...
function submit(){
	window.location="?page=riwayat_beli&dari=" + $('#tgl_dari').val() + "&sampai=" + $('#tgl_sampai').val();
}
