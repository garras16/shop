                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <a class="btn btn-danger" href="javascript:history.back()">
                            ...
                            Kembali</a><br/><br/>
                        <!--<a class="btn btn-danger" href="?page=komisi&mode=view_detail&id="<?php echo
                        $row['id_karyawan'] ?>""><i class="fa fa-arrow-left"></i>
                        Kembali</a><br/><br/>-->
                        ...
                        <div class="input-group">
                            ...
                            <input
                                class="form-control"
                                placeholder="<?php echo $row['nama_karyawan'] ?>"
                                readonly="readonly">
                        </div>
                        <br/><br/>
                        ...
                        <div id="kredit_content" class="col-md-12"></div>
                        <div id="input_kredit" class="col-md-12"></div>
                        <div class="clearfix"></div><br/>
...
<script>
    function addRow() {
        $('#input_kredit').load(
            'assets/page/komisi/input_kredit.php?id=<?php echo $id ?>'
        );
    ...
    $(document).ready(function () {
        $('#kredit_content').load(
            'assets/page/komisi/content_kredit.php?id=<?php echo $id ?>'
        );
    });
</script>