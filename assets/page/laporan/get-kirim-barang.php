...
<div class="input-group">
    ...
    <input
        ...
        value="<?php echo date("d-m-Y",strtotime($row['tanggal_kirim'])) ?>"
        readonly="readonly">
    <span class="input-group-addon">
...
<div class="input-group">
    ...
    <select class="form-control select2" id="select_jenis" name="jenis">
        <option value="DALAM KOTA" selected="selected">Dalam Kota</option>
        <option value="LUAR KOTA" selected="selected">Luar Kota</option>
    </select>
    <span class="input-group-addon">
        <i class="fa fa-star fa-fw" style="color:red"></i>
    </span>
...
<div class="input-group">
    ...
    <select
        ...
        name="id_ekspedisi"
        <?php echo $lock ?>>
        <option value="" selected="selected">Kirim Sendiri</option>
        <?php
...
<div class="input-group">
    ...
    <select
        ...
        name="berat_volume"
        <?php echo $locked ?>>
        <option value="berat" selected="selected">BERAT (GRAM)</option>
...
<div class="input-group">
    ...
    <input
        class="form-control locked mask"
        id="val_berat_volume"
        type="text"
        name="val_berat_volume"
...
<script>
    ...
    $("#select_jenis")
        .val("<?php echo $row['jenis'] ?>")
        .trigger("change");
    $("#select_karyawan")
        .val("<?php echo $row['id_karyawan'] ?>")
        .trigger("change");
    $("#select_ekspedisi")
        .val("<?php echo $row['id_ekspedisi'] ?>")
        .trigger("change");
    <?php 
if(isset($tipe)) {
