	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="get_nota" class="col-xs-12">
...
$(document).ready(function(){
	...
	$('#myModal').on('show.bs.modal', function(e){
		...
		$('#get_nota').html('<center><i class="fa fa-spinner fa-spin" style="font-size:24px"></i></center>');
		$('#get_nota').load('assets/page/laporan/get-canvass-jual.php?id=' + id_canvass,function(){
			getDataTable();
		});
	});
})
