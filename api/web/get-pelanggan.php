...
<div class="input-group">
	...
	<input class="form-control" id="nama" name="nama_pelanggan" style="padding: 20px 15px;" placeholder="Nama Pelanggan" value="<?php echo $row['nama_pelanggan']; ?>" maxlength="50" required>
...
<div class="input-group">
	...
	<input name="lat" class="form-control" placeholder="Latitude" style="padding: 20px 15px;" value="<?php echo $row['lat']; ?>" maxlength="50" readonly>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-map-marker fa-fw" style="width: 59px;"></i><br><small>Longitude</small></span>
	<input name="lng" class="form-control" placeholder="Longitude" style="padding: 20px 15px;" value="<?php echo $row['lng']; ?>" maxlength="50" readonly>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-phone fa-fw" style="width: 59px;"></i><br><small>Telepon</small></span>
	<input class="form-control" type="number" name="telepon_pelanggan" style="padding: 20px 15px;" placeholder="Telepon Pelanggan" value="<?php echo $row['telepon_pelanggan']; ?>" onKeyPress="if(this.value.length==20) return false;" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
...
<div class="input-group">
	...
	<input name="barcode" class="form-control" placeholder="Barcode" style="padding: 20px 15px;" value="<?php echo $row['barcode']; ?>" maxlength="20" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
