...
<div class="input-group">
	...
	<input class="form-control" id="nama_barang" style="padding: 20px 15px;" name="nama_barang" value="<?php echo $row['nama_barang']; ?>" maxlength="100" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-barcode fa-fw" style="width: 55px;"></i><br><small>Barcode</small></span>
	<input id="barcode" name="barcode" style="padding: 20px 15px;" class="form-control" placeholder="Barcode" value="<?php echo $row['barcode']; ?>" maxlength="30" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
...
<div class="input-group">
	...
	<input id="min_order_2" name="min_order" class="form-control" style="padding: 20px 15px;" placeholder="Minimal Jual" min="1" onKeyPress="if(this.value.length==6) return false;" value="<?php echo $row['min_order']; ?>" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-warning fa-fw" style="width: 55px;"></i><br><small>Stok Min.</small></span>
	<input id="stok_min_2" name="stok_minimal" class="form-control" style="padding: 20px 15px;" placeholder="Stok Minimal" min="1" onKeyPress="if(this.value.length==6) return false;" value="<?php echo $row['stok_minimal']; ?>" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-certificate fa-fw" style="width: 55px;"></i><br><small>No. Ijin</small></span>
	<input id="ijin" name="ijin" class="form-control" style="padding: 20px 15px;" placeholder="No. Ijin" value="<?php echo $row['no_ijin']; ?>" maxlength="25" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
...
<div class="input-group">
	<span class="input-group-addon" style="padding: 2px 12px;"><i class="fa fa-flag fa-fw"></i><br><small>Tampilkan</small></span>
