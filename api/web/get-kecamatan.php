...
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-tag fa-fw" style="width: 38px;"></i><br><small>Kec.</small></span>
	<input class="form-control" placeHolder="Nama Kecamatan" style="padding: 20px 15px;" name="kecamatan" value="<?php echo $row['nama_kec']; ?>" maxlength="40" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>