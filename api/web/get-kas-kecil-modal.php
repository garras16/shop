...
<div class="input-group">
    <span class="input-group-addon">
        <i class="fa fa-file fa-fw" style="width: 35px;"></i><br>
        <small>Nama</small>
    </span>
    <input
        class="form-control"
        ...
        placeholder="Nama Kas Kecil"
        value="<?php echo $row['nama_kas_kecil']; ?>"
        maxlength="100"
        required="required">
    <span class="input-group-addon">
...
<div class="input-group">
    <span class="input-group-addon" style="padding: 2px 12px;">
        <i class="fa fa-archive fa-fw" style="width: 35px;"></i><br>
        <small>Jenis</small>
    </span>
    <select class="form-control" id="select_jenis" name="jenis" required="required">
        <option value="" disabled="disabled" selected="selected">Pilih Jenis</option>
        <option
            value="MASUK"
            <?php echo ($row['jenis'] == 'MASUK' ? 'selected' : '') ?>>KAS MASUK</option>
        <option
            value="KELUAR"
            <?php echo ($row['jenis'] == 'KELUAR' ? 'selected' : '') ?>>KAS KELUAR</option>
    </select>
    <span class="input-group-addon">
        <i class="fa fa-star fa-fw" style="color:red"></i>
    </span>
