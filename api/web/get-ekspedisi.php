...
<div class="input-group">
	...
	<input class="form-control" id="nama" name="nama_ekspedisi" style="padding: 20px 15px;" placeholder="Nama Ekspedisi" maxlength="50" value="<?php echo $row['nama_ekspedisi'] ?>" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-phone fa-fw" style="width: 42px;"></i><br><small>Tlp.</small></span>
	<input name="telepon" type="number" class="form-control" style="padding: 20px 15px;" placeholder="Telepon Ekspedisi" value="<?php echo $row['telepon'] ?>" onKeyPress="if(this.value.length==20) return false;" required>
	<span class="input-group-addon"><i class="fa fa-star fa-fw" style="color:red"></i></span>
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-user fa-fw" style="width: 42px;"></i><br><small>Kontak</small></span>
	<input class="form-control" name="kontakperson" placeholder="Kontak Person" style="padding: 20px 15px;" value="<?php echo $row['kontakperson'] ?>"  maxlength="50">
</div>
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-phone fa-fw" style="width: 42px;"></i><br><small>Telepon</small></span>
	<input class="form-control" type="number" name="telepon_kontak" style="padding: 20px 15px;" placeholder="Telepon Kontak Person" value="<?php echo $row['telepon_kontak'] ?>"  onKeyPress="if(this.value.length==20) return false;">
</div>
<div class="input-group">
