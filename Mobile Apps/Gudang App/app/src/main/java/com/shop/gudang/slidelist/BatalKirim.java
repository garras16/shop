...
import com.shop.gudang.*;

public class BatalKirim extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mWeb = App.getWeb() + "/?page=gudang&mode=batal_kirim";
	...
	private class MyBrowser extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url){
			...
			view.addJavascriptInterface(new Object()
			{
				...
				@JavascriptInterface
				public void Pesan(int id) throws Exception
				{
					((MainActivity) getActivity()).changePesan(id);
				}
			}, "AndroidFunction");
		}
