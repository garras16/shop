...
public class KonfirmasiNotaBeli extends Fragment
{
	private WebView myView;
	private String mUrl, mWeb, barcode1, barcode2;
	private String id_beli_detail, tipe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mUrl = App.getHOST();
		//mUrl = "silsoft.id";//-test.000webhostapp.com";
		//mWeb = "http://" + mUrl + "/shop/?page=gudang&mode=konfirm_beli";
		//mWeb = "http://" + mUrl + "/mobile/?page=gudang&mode=konfirm_beli";
		mWeb = App.getWeb() + "/?page=gudang&mode=konfirm_beli";
		myView = rootView.findViewById(R.id.webView);
	...
	private class MyBrowser extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url){
			...
			{
				@JavascriptInterface
				public void scan_barang(String barcode, String id) {
					tipe="scan_barang";
					barcode1=barcode;
					id_beli_detail=id;
					scan_barcode("Barang");
		...
		if (requestCode == 0) {
			if (resultCode == Activity.RESULT_OK) {
				...
				if (tipe.equals("scan_barang")){
					myView.evaluateJavascript("barcode('" + barcode1 + "','" + barcode2 + "'," + id_beli_detail + ");", null);
				} else if (tipe.equals("scan_rak")){
					myView.evaluateJavascript("barcode('" + barcode2 + "');", null);
				}
