...
public class KonfirmasiReturJual extends Fragment
{
	private WebView myView;
	private String mUrl, mWeb, barcode1, barcode2;
	private String id_retur_jual_detail, tipe;
	private boolean eror, timeout, handle, webprint;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mUrl = App.getHOST();
		mWeb = App.getWeb() + "/?page=gudang&mode=konfirm_retur_jual";
	...
	private class MyBrowser extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url){
			...
			view.addJavascriptInterface(new Object()
			{
				...
				{
					tipe="scan_barang";
					barcode1=barcode; id_retur_jual_detail=id;
					scan_barcode("Barang");
				}
				@JavascriptInterface
				public void scan_rak() throws Exception
				{
					tipe="scan_rak";
					scan_barcode("Rak");
				}
		...
		if (requestCode == 0) {
			if (resultCode == Activity.RESULT_OK) {
				...
				if (tipe.equals("scan_barang")){
					myView.evaluateJavascript("barcode('" + barcode1 + "','" + barcode2 + "'," + id_retur_jual_detail + ");", null);
				} else if (tipe.equals("scan_rak")){
					myView.evaluateJavascript("cek_scan_rak('" + barcode2 + "');", null);
				}
	...
	private void createConfirm(String pesan){
		AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
		builder.setTitle("Gudang App")
		    .setIcon(R.drawable.ic_launcher)
		    .setMessage(pesan)
			...
			new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					dialog.cancel();
					createConfirm2("Apakah Anda Benar-Benar Yakin?");
				}
			})
		    .setNegativeButton(
			"TIDAK",
	...
	private void createConfirm2(String pesan){
		AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
		builder.setTitle("Gudang App")
		    .setIcon(R.drawable.ic_launcher)
		    .setMessage(pesan)
			...
			new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					...
					myView.post(new Runnable() {
						@Override
						public void run() {
							myView.evaluateJavascript("submit();", null);
						}
					});
				}
			})
	...
	private void createWebPrintJob(WebView webView) {
		PrintManager printManager = (PrintManager) getActivity().getSystemService(getActivity().PRINT_SERVICE);
