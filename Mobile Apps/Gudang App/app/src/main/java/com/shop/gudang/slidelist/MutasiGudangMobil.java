...
public class MutasiGudangMobil extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mUrl = App.getHOST();
		mWeb = App.getWeb() + "/?page=canvass_keluar&mode=ambil_gudang";
	...
	private class MyBrowser extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url){
			...
			if (dialog !=null && dialog.isShowing()) dialog.dismiss();
			if (url.contains("&print")) createWebPrintJob(view);
			view.addJavascriptInterface(new Object()
			{
				@JavascriptInterface
				public void scan_barang() throws Exception
				{
					tipe="scan_barang";
					scan_barcode("Barang");
				}
				...
				@JavascriptInterface
				public void scan_barang2() throws Exception
				{
					tipe="scan_barang2";
					scan_barcode("Barang");
				}
				@JavascriptInterface
				public void scan_rak2() throws Exception
				{
					tipe="scan_rak2";
					scan_barcode("Rak");
				}
		...
		if (requestCode == 0) {
			if (resultCode == Activity.RESULT_OK) {
				...
				if (tipe.equals("scan_barang")){
					myView.evaluateJavascript("cek_scan_barang('" + barcode2 + "');", null);
				} else if (tipe.equals("scan_rak")){
					myView.evaluateJavascript("cek_scan_rak('" + barcode2 + "');", null);
				} else if (tipe.equals("scan_barang2")){
					myView.evaluateJavascript("cek_scan_barang2('" + barcode2 + "');", null);
				} else if (tipe.equals("scan_rak2")){
					myView.evaluateJavascript("cek_scan_rak2('" + barcode2 + "');", null);
				}
