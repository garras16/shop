...
import com.shop.admin.slidelist.Home;
import com.shop.admin.slidelist.Penagihan;
import com.shop.admin.slidelist.Setoran;
import com.shop.admin.slidelist.HistoriPenagihan;
...
public class MainActivity extends Activity {
	...
	private void updateDisplay(int position) {
		...
		switch (position) {
		case 0:
			fragment = new Penagihan();
			break;
		case 1:
			fragment = new Setoran();
			break;
		case 2:
			fragment = new HistoriPenagihan();
			break;
		default:
			fragment = new Home();
			break;
	...
	private void CreateExitDialog() {
		...
		alertDialogBuilder.setTitle("Admin App");
		alertDialogBuilder
