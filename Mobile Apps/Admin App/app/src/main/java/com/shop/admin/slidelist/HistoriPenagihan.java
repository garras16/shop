package com.shop.admin.slidelist;
...
import com.shop.admin.DetectConnection;
import com.shop.admin.App;
import com.shop.admin.R;

public class HistoriPenagihan extends Fragment
{
	private WebView myView;
	private String mUrl, mWeb, barcode2, tipe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mUrl = App.getHOST();
		mWeb = App.getWeb() + "/?page=admin&mode=lap_histori_penagihan";
	...
	private void scan_barcode(String tipe_scan){
		Intent intent = new Intent("com.google.zxing.client.android.SCAN0");
