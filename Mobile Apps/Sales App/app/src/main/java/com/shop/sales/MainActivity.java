...
import com.shop.sales.slidelist.Home;
import com.shop.sales.slidelist.Pesan;
import com.shop.sales.slidelist.Checkin;
import com.shop.sales.slidelist.Checkin_Canvass;
import com.shop.sales.slidelist.Tagihan;
import com.shop.sales.slidelist.*;
...
public class MainActivity extends Activity {
	...
	private void updateDisplay(int position) {
		...
		case 0:
			...
			break;
		case 1:
			fragment = new Checkin_Canvass();
			break;
		case 2:
			fragment = new Tagihan();
			break;
		case 3:
			fragment = new ReturJual();
			break;
		case 4:
			fragment = new Pesan();
			break;
	...
	private void CreateExitDialog() {
		...
		alertDialogBuilder.setTitle("Sales App");
		alertDialogBuilder
