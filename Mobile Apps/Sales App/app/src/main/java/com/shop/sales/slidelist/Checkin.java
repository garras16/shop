...
public class Checkin extends Fragment
{
	...
	private static Handler myHandler, myHandler2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mUrl = App.getHOST();
		mWeb = App.getWeb() + "/?page=sales&mode=checkin";
		orientation(0);
		...
		run2 = new Runnable() {
			public void run() {
				if(checkGPS()) {
					...
					myHandler2 = new Handler(Looper.myLooper());
					myHandler2.postDelayed(run2, 1000);
				}
			}
		};
	...
	public void quit_handler(){
		...
		if (myHandler2 != null) {
			myHandler2.removeCallbacks(run2);
		}
	}
