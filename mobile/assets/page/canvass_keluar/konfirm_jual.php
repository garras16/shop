...
(($row2['plafon']-$jumlah_gantung) < $jumlah_gantung ? $style="color:red" : $style="");
		echo '<tr>
				...
				<td align="center"><a style="' .$style. '" href="?page=canvass_keluar&mode=konfirm_jual_2&id=' .$row2['id_jual']. '"><div style="min-width:70px">' .format_uang($jumlah_gantung). '<br/> (' .$jml_nota. ' nota)</div></a></td>
				<td align="center"><a style="' .$style. '" href="?page=canvass_keluar&mode=konfirm_jual_2&id=' .$row2['id_jual']. '"><div style="min-width:70px">' .format_uang($row2['plafon']). '</div></a></td>
				<td align="center"><a style="' .$style. '" href="?page=canvass_keluar&mode=konfirm_jual_2&id=' .$row2['id_jual']. '"><div style="min-width:70px">' .format_uang($row2['plafon']-$jumlah_gantung). '</div></a></td>
				<td align="center"><a style="' .$style. '" href="?page=canvass_keluar&mode=konfirm_jual_2&id=' .$row2['id_jual']. '"><div style="min-width:70px">' .format_uang($r['total_harga']). '</div></a></td>
			</tr>';
	}
	}
?>
...
ORDER BY jual.id_jual DESC");
	...
	$row4=mysql_fetch_array($sql4);
		echo '<tr>
				...
				<td align="center"><a href="?page=canvass_keluar&mode=konfirm_jual_3&id=' .$row['id_jual']. '"><div style="min-width:70px">' .format_uang($jumlah_gantung). '<br/> (' .$jml_nota. ' nota)</div></a></td>
				<td align="center"><a href="?page=canvass_keluar&mode=konfirm_jual_3&id=' .$row['id_jual']. '"><div style="min-width:70px">' .format_uang($row['plafon']). '</div></a></td>
				<td align="center"><a href="?page=canvass_keluar&mode=konfirm_jual_3&id=' .$row['id_jual']. '"><div style="min-width:70px">' .format_uang($row['plafon']-$jumlah_gantung). '</div></a></td>
				<td align="center"><a href="?page=canvass_keluar&mode=konfirm_jual_3&id=' .$row['id_jual']. '"><div style="min-width:70px">' .format_uang($row['total_harga']). '</div></a></td>
