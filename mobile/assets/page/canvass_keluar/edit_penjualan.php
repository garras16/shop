	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h3>UBAH NOTA PENJUALAN (CANVASS)</h3>
					</div>
					<div class="x_content">
						<div id="content">
...
function getBack(){
	if ($('#myModal').is(':visible')){
		...
		window.location="?page=canvass_keluar&mode=view_penjualan";
	}
}
...
$(document).ready(function(){
	...
	$('#myModal').on('show.bs.modal', function(e){
		...
		if (jenis=='Lunas'){
			$('#get_barang').load('assets/page/canvass_keluar/input_brg_tunai.php?id=' + id,function(){
			});
		} else {
			$('#get_barang').load('assets/page/canvass_keluar/input_brg_kredit.php?id=' + id + '&tenor=' + tenor,function(){
			});
		}
	})
})
