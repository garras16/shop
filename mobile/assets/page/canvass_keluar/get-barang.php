...
<div class="input-group">
	<span class="input-group-addon" style="padding: 2px 12px;"><i class="fa fa-file fa-fw" style="width: 35px;"></i><br><small>Barang</small></span>
...
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-tags fa-fw" style="width: 35px;"></i><br><small>Qty</small></span>
	<input class="form-control" data-min="" type="tel" id="qty" style="padding:19px 10px;" name="qty" value="" autocomplete="off" placeHolder="Qty" required>
