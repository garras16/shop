	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<div class="x_title">
						<h3>SETORAN TANGGAL <?php echo date("d-m-Y");?></h3>
							<?php
							if (isset($pesan)){
			...
			<div class="modal-body">				
				<form action="" method="post" onsubmit="return cek_valid();">
					...
					<div class="form-group col-sm-12">
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-tags fa-fw"></i> Jumlah Setor (Rp)&nbsp</span>
							<input class="form-control" type="tel" id="setor" name="setor" placeholder="Jumlah Setor" value="">
						</div>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-calendar fa-fw"></i> Kunjungan berikutnya</span>
...
$(document).ready(function(){
	...
	$('#myModal').on('show.bs.modal', function(e){
		...
		if (status_nota!=2) $('#scan_nota').click();
		if (status_bayar==3){
			$('#bayar').val('0');
			$('#setor').val('0');
