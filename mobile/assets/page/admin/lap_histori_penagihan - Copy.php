				...
				<div class="x_panel">
					...
					<div class="x_content">
						<div class="col-xs-12" style="text-align:left">
							<input type="text" id="datepicker" PlaceHolder="Bulan & Tahun" style="width:100px" value="<?php if (isset($_GET['tanggal'])) echo $_GET['tanggal'] ;?>" readonly></input>
...
$total_jual=0;
	...
	($row['tgl_janji_next']=='' ? $tgl_jb='' : $tgl_jb=date('d-m-Y',strtotime($row['tgl_janji_next'])));
		echo '<tr>
				<td align="center"><a href="?page=admin&mode=lap_histori_penagihan_2&id=' .$row['id_penagihan']. '"><div style="min-width:70px">' .date("d-m-Y",strtotime($row['tanggal_tagih'])). '</div></a></td>
				<td align="center"><a href="?page=admin&mode=lap_histori_penagihan_2&id=' .$row['id_penagihan']. '"><div style="min-width:70px">' .format_uang($total_jual). '</div></a></td>
				<td align="center"><a href="?page=admin&mode=lap_histori_penagihan_2&id=' .$row['id_penagihan']. '"><div style="min-width:70px">' .$row['nama_karyawan']. '</div></a></td>
				<td align="center"><a href="?page=admin&mode=lap_histori_penagihan_2&id=' .$row['id_penagihan']. '"><div style="min-width:70px">' .format_uang($row['bayar']). '</div></a></td>
			</tr>';
...
function cari_debt_pelanggan(){
	...
	var url = "?page=admin&mode=lap_histori_penagihan&tanggal=" + tanggal + "&debt=" + debt + "&pelanggan=" + pelanggan;
